...
python imagen-video-training.py \
--audio_embed_dim 768 \
--audio_path ./datasets/preprocessed_dataset/hubert-base \
--gif_path ./datasets/preprocessed_dataset/train 
# --audio_pooling \
# --from_pretrained \
# --pretrained_path ./checkpoints/ImagenVideo-Modelwav2vec2-l60-pho-PoolingTrue-IgnoreTimeFalse-TwoStepTrue-100